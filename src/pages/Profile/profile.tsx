    ...
    <div className=" min-h-screen flex items-center justify-center p-4 md:p-10">
      <div className="shadow-md rounded-2xl w-full max-w-6xl grid md:grid-cols-3 gap-6 p-6 md:p-40">
        ...
        <div className="md:col-span-2 text-right space-y-6">
          ...
          <div>
            <h2 className="font-semibold text-gray-700 mb-2 dark:text-[#BDBDBD]">وسائل التواصل</h2>
          ...
          <div>
            <h2 className="font-semibold text-gray-700 mb-2 dark:text-[#BDBDBD]">الوصف</h2>
            <div className="flex gap-2 items-start text-gray-600 text-sm dark:text-[#BDBDBD]">
              ...
              <FaRegFileAlt className="w-[50px] h-[40px] text-lg mt-1 h-30 dark:text-[#BDBDBD]" />
            </div>
          </div>
        </div>
