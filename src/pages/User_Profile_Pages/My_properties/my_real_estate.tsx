    ...
    <section className="py-10 w-full px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          {/* السهم السابق ← */}
          <button className="custom-prev absolute top-1/2 left-[-20px] z-10 -translate-y-1/2 bg-white shadow-md p-2 rounded-full">
          ...
          {/* السهم التالي → */}
          <button className="custom-next absolute top-1/2 right-[-20px] z-10 -translate-y-1/2 bg-white shadow-md p-2 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            {properties.map((property) => (
              <SwiperSlide key={property.id}>
                <div className="px-2">
                  <ApartmentCard className="w-full" />
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
