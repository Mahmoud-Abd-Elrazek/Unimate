...
const ApartmentCard = () => {
  ...
  return (
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden w-[310px] group relative ">
  ...
  <div className="relative">  
    ...
    {currentIndex > 0 && (
      <button
        ...
        className="absolute left-3 top-1/2 -translate-y-1/2 bg-white w-[32px] h-[32px] rounded-full shadow-lg z-10 flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
    ...
    {currentIndex < images.length - 1 && (
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 bg-white w-[32px] h-[32px] rounded-full shadow-lg z-10 flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
