...
// const FavApartmentCard = ({ className = "", edit = false, data, id }: ApartmentCardProps) => {
...
//   })
//   const {flag,DeleteFavorite,ToggelFav} = useApartmentStore()
...
//       export default FavApartmentCard;
