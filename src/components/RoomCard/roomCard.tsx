...
export default function RoomCard() {
    return (
        <div className="rounded">
            <div className="card dark:bg-[#1A1A1A] dark:text-[#E0E0E0] " style={{ 'width': '18rem'}} >
                ...
                <div className="  mt-5 px-2 text-right">
                    ...
                    <div className="flex justify-around items-ceenter mt-20 mb-3">
                        ...
                        <Link to="/" className="btn hover:bg-slate-300 bg-gray-300 dark:bg-gray-400 dark:hover:bg-gray-700">حجز غرفه بالكامل</Link>
                    </div>
                </div>
            </div>
        </div>
