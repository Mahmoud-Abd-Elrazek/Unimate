...
export default function Footer() {
    return (
        <div className=' py-10 w-full bg-[#EFEFEF] grid place-items-center gap-4 md:gap-10 dark:bg-[#1A1A1A] '>
            {/* First Row */}
            <div className='flex flex-wrap justify-center items-center gap-3 md:gap-14 px-4 md:px-20 w-full max-w-6xl text-[#212529] text-[15px] sm:text-[14px] text-center md:text-[15px]'>
                <a href="#" className='cursor-pointer border-b-2 border-transparent hover:border-gray-500 dark:text-[#E0E0E0]'>
                    الرئيسية
                </a>
                <a href="#" className='cursor-pointer border-b-2 border-transparent hover:border-gray-500 dark:text-[#E0E0E0]'>
                    سياسة الخصوصية
                ...
                <a href="#" className='cursor-pointer font-bold border-b-2 border-transparent hover:border-gray-500 dark:text-[#E0E0E0]'>
                    انضم كاصاحب مسكن
                </a>
            </div>

            {/* Social Icons */}
            <div className='flex justify-center gap-6 text-[#212529] dark:text-[#E0E0E0]'>
            ...
            {/* Copyrights */}
            <div className='flex flex-wrap justify-center items-center text-center text-[#212529] font-[Nunito] dark:text-[#E0E0E0]'>
